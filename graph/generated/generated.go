...
var sources = []*ast.Source{
  ...
  transfer(from_address: ID!, to_address: ID!, amount: Int!): Int!
}
`, BuiltIn: false},
}
...
func (ec *executionContext) field_Mutation_transfer_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "from_address", ec.unmarshalNID2string)
	if err != nil {
		return nil, err
	}
	args["from_address"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "to_address", ec.unmarshalNID2string)
	if err != nil {
		return nil, err
	}
	args["to_address"] = arg1
	arg2, err := graphql.ProcessArgField(ctx, rawArgs, "amount", ec.unmarshalNInt2int)
	if err != nil {
		return nil, err
	}
	args["amount"] = arg2
